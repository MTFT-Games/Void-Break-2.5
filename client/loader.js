...
const imageSources = {
	purple5: '/assets/img/backgrounds/large/purple/purple-nebula-5.jpg',
	purple6: '/assets/img/backgrounds/large/purple/purple-nebula-6.jpg'
};

// Load sounds
game.sounds.shoot1 = new Howl({ src: ['/assets/sounds/shoot1.wav'] });
game.sounds.shoot1.volume(0.3);
game.loading += 100.0 / loadingTotal;

game.sounds.hit1 = new Howl({ src: ['/assets/sounds/hit1.wav'] });
game.sounds.hit1.volume(0.5);
game.loading += 100.0 / loadingTotal;

game.sounds.hit2 = new Howl({ src: ['/assets/sounds/hit2.wav'] });
game.sounds.hit2.volume(0.5);
game.loading += 100.0 / loadingTotal;

// Load JSON
fetch('/assets/data/defaults.json')
